...
class run_experiment(EnvExperiment):
    ...
    def run(self):
        ...
        while True:
            ...
            self.urukul2_ch2.set(frequency = (80.0)*MHz, amplitude = (10.0)/100 , phase = (180)/360, profile=1)
            self.urukul2_ch2.set(frequency = (80.0)*MHz, amplitude = 0. , phase = (0.0)/360, profile=3)
