...
class run_experiment(EnvExperiment):
    ...
    def run(self):
        ...
        self.urukul2_ch2.set(frequency = (100.0)*MHz, amplitude = (10.0)/100 , phase = (0.0)/360, profile=1)
        self.urukul2_ch2.set(frequency = (80.0)*MHz, amplitude = 0. , phase = (0.0)/360, profile=7)

        while True:
            camera_enabled = True   # continuous run
            run_index = 0
            delay(100*ns)
