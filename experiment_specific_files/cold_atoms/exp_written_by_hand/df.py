    ...
    def run(self):
        ...
        for run_index in range(6):   # run loop including camera warm-up: warmup = 5, actual = 1, total = 6
            ...
            for step1 in range(101):
                ...
                self.urukul1_ch0.set(frequency = (80.0)*MHz, amplitude = (40.0)/100 , phase = (0.0)/360,profile=0)
                self.urukul1_ch0.sw.off() 
                self.urukul1_ch1.set_att((0.5)*dB) 
                self.urukul1_ch1.set(frequency = (182.65)*MHz, amplitude = (30.0)/100 , phase = (0.0)/360,profile=0)
                ...
                self.urukul1_ch3.set(frequency = (228.331)*MHz, amplitude = (10.0)/100 , phase = (0.0)/360,profile=0)
                ...
                self.ttl12.off()
                self.urukul1_ch2.set_att((0.0)*dB) 
                self.urukul1_ch2.set(frequency = (self.df[step1])*MHz, amplitude = (29.0)/100 , phase = (0.0)/360)
                self.urukul1_ch2.sw.on() 
