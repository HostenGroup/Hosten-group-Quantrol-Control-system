...
class run_experiment(EnvExperiment):
    ...
    def run(self):
        ...
        for run_index in range(1):   # run loop including camera warm-up: warmup = 0, actual = 1, total = 1
            ...
            self.check_host_stop_and_run()  # if true stops the experiment
    ...
    @rpc
    def check_host_stop_and_run(self):
        ...
        try:
            ...
            print('check_host_stop_and_run error:', exc)
    ...
    def copy_dataset_file(self):
        ...
        experimental_path = 'G:\\Experimental Data\\Atom Interferometer experiment\\Raman\\Raman transition\\2026_04_23\\16_53_19'
        experimental_metadata_path = 'G:\\Experimental Data\\Atom Interferometer experiment\\Raman\\Raman transition\\2026_04_23\\16_53_19'
