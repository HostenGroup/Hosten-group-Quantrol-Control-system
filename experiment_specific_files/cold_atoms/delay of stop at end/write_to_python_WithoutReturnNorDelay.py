...
def create_experiment(self, run_continuous = False, multiple_runs = False):
    ...
    if stop_at_end_of_sequence_flag == True:
        file.write(indentation + "self.create_run_active_file() \n")
        file.write(indentation + 'do_stop = 0 \n')
    ...
    if stop_at_end_of_sequence_flag == True:
        file.write('\n')
        file.write(indentation + 'if do_stop == 1:\n')
        file.write(indentation + '    self.execute_stop()\n')
        file.write(indentation + 'if do_stop == 2:\n')
        file.write(indentation + '    self.execute_new()\n')

    # If GUI requested stop_at_end_of_sequence, check host flag and execute stop/new actions
    file.write('\n')
    if stop_at_end_of_sequence_flag == True:
        file.write(indentation + 'do_stop = self.check_host_stop()\n')
        file.write('\n')
    ...
    # RPC helpers: stop/new checks and host-side actions
    if stop_at_end_of_sequence_flag == True:
        file.write('\n')
        file.write(indentation + "@rpc\n")
        file.write(indentation + "def check_host_stop(self) -> TInt32:\n")
        indentation += '    '
        ...
        indentation += '    '
        file.write(indentation + "print('check_host_stop error:', exc)\n")
        indentation = indentation[:-4]
        ...
        file.write('\n')
        file.write(indentation + "@rpc\n")
        file.write(indentation + "def execute_stop(self):\n")
        indentation += '    '
        file.write(indentation + "self.repo_path = Path(__file__).resolve().parent.parent\n")
        file.write(indentation + "try:\n")
        indentation += '    '
        ...
        file.write('\n')
        file.write(indentation + "@rpc\n")
        file.write(indentation + "def execute_new(self):\n")
        indentation += '    '
        file.write(indentation + "self.repo_path = Path(__file__).resolve().parent.parent\n")
