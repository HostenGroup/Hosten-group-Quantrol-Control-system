...
class run_experiment(EnvExperiment):
    def build(self):
        ...
        self.dt = list(np.linspace(0.000000, 1.000000, 10))


    def prepare(self):  #NEED
        ...
        self.backup_directory = "C:/Users/HostenGroup/Desktop/Hosten-group-Quantrol-Control-system/save_to" 
    ...
    def run(self):
        ...
        samp2 = 0.0
        samp3 = 0.0
        for run_index in range(3):   # run loop including camera warm-up
            ...
            for step in range(10):
                ...
                if not camera_enabled: 
                    break 
        self.copy_dataset_file()


    @rpc
    def store_sample(self, run_index, step, value1, value2):
        #Store tuple (run, step, value)
        self.append_to_dataset("data", (int(run_index), int(step), value1, value2))
        
    def copy_dataset_file(self):
        source_file ="C:/Users/HostenGroup/Desktop/Hosten-group-Quantrol-Control-system/dataset_db.pyon"
        target_file = os.path.join(self.backup_directory,"dataset_db_copy.pyon")
