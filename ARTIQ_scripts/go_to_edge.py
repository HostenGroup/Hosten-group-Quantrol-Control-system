...
class go_to_edge(EnvExperiment):
    ...
    def run(self):
        ...
        self.zotino0.write_dac(1, -4.000000)
        self.zotino0.write_dac(2, 0.000000)
        self.zotino0.write_dac(3, -0.950000)
        ...
        self.urukul0_ch0.set(frequency = 0.0*MHz, amplitude = 90.0/100, phase = (0.0)/360)
        self.urukul0_ch0.sw.on() 
        self.urukul0_ch1.set_att(0.5*dB) 
        self.urukul0_ch1.set(frequency = 0.0*MHz, amplitude = 30.0/100, phase = (0.0)/360)
