...
class go_to_edge(EnvExperiment):
    ...
    def run(self):
        ...
        self.zotino0.write_dac(1, -6.000000)
        self.zotino0.write_dac(2, 3.000000)
        self.zotino0.write_dac(3, -6.000000)
        self.zotino0.write_dac(4, 0.000000)
        self.zotino0.write_dac(5, 0.000000)
        self.zotino0.write_dac(6, 5.000000)
        ...
        self.urukul1_ch1.set(frequency = 182.65869*MHz, amplitude = 30.0/100, phase = (0.0)/360)
        ...
        self.urukul1_ch3.set(frequency = 227.0*MHz, amplitude = 10.0/100, phase = (0.0)/360)
